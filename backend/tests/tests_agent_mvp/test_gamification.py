...
from agents.deterministic_agents.gamification_rules import GamificationRules
from models.contracts import GamificationState, XpTransaction
...
class TestGamificationRules:
    ...
    async def test_update_xp_task_completion(self, gamification_rules, mock_storage):
        # Setup
        with patch('agents.deterministic_agents.gamification_rules.get_supabase') as mock_supabase:
