...
pytest -q backend/tests/test_agent_mvp/test_do_selector.py -k opik_trace_smoke
...
from agents.deterministic_agents.do_selector import DoSelector, select_optimal_task
