...
class RaimonOrchestrator:
    ...
    def __init__(self):
        ...
        self.agents = {}  # Can be populated by factory or used directly
    ...
    def _handle_checkin(self, state: GraphState) -> GraphState:
        ...
        try:
            ...
            daily_checkin = DailyCheckIn(
                date=datetime.now(timezone.utc).isoformat().split('T')[0],  # YYYY-MM-DD format
    ...
    def _handle_do_next(self, state: GraphState) -> GraphState:
        ...
        try:
            ...
            try:
                ...
                from models.contracts import UserProfileAnalyzeRequest
            ...
            if not state.selection_constraints:
                ...
                if latest_checkin:
                    ...
                    checkin_obj = DailyCheckIn(
                        date=latest_checkin.get('date', datetime.now(timezone.utc).isoformat().split('T')[0]),
