...
async def get_dashboard_summary(
    ...
    energy_level = checkin.data.get("energy_level") if checkin.data else None
...
async def get_greeting_message(
    ...
    streak_count = streak.data.get("current_count", 0) if streak.data else 0
    ...
    return {
        ...
        "data": {
            ...
            "messages": messages,
            "streak": streak_count,
            "checked_in": checkin.data is not None,
        },
    }
