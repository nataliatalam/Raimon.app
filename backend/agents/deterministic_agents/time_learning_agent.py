...
from services.storage_service import get_user_sessions, get_user_checkins, save_ai_learning
...
def _save_time_patterns(user_id: str, patterns: TimePatterns) -> None:
    ...
    try:
        save_ai_learning(
            ...
            expires_at=datetime.now(timezone.utc) + timedelta(days=14),  # Refresh bi-weekly
        )
