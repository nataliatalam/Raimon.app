...
from services.storage_service import get_user_profile, get_gamification_state, get_recent_sessions
from services.llm_service import LLMService
from orchestrator.validators import validate_coach_output, fallback_coach
...
def generate_coaching_message(
    ...
    try:
        ...
        response = llm_service.generate_json(prompt, max_tokens=200)
