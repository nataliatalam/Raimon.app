...
from services.storage_service import get_gamification_state, get_recent_sessions, get_user_profile
...
def _generate_motivation_message(data: Dict[str, Any], tone: str, llm_service: Optional[LLMService] = None) -> str:
    """Generate bounded motivation message using LLM service."""
    try:
        ...
        response = service.generate_json(prompt, max_tokens=100)
