...
from services.storage_service import get_project_data, get_project_tasks, get_project_sessions, get_project_checkins, save_ai_learning
...
def _refine_insights_with_llm(
    ...
    """Use LLM service to refine and enhance insights."""
    ...
    try:
        ...
        response = service.generate_json(prompt, max_tokens=300)
